...
sha1_chunk:
    ...
    wordloop:                           # Extend the 32-bit words
        ...
        xor     %r13d,%r12d               
        roll    $1,%r12d                  
        movl    %r12d,(%rsi, %rax, 4)   #store answer in w[i]
        inc     %rax                        
        jmp     wordloop                   

    Initialize:                         # Initialize hash value for this chunk:
        movl    (%rdi),%r15d            # a = h0
        movl    %r15d,a
    ...
    general:                            # general hashing for all 32 bit words.
